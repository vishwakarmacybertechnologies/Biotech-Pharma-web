...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (tableBody) {
        ...
        function renderTable(data) {
            tableBody.innerHTML = '';
            if (data.length === 0) {
                tableBody.innerHTML = '<tr><td colspan="3" class="text-center" style="padding: 3rem 1rem;">No formulations found matching your search.</td></tr>';
                return;
            }
            ...
            data.forEach(product => {
                ...
                tr.innerHTML = `
                    ...
                    <td><span style="background: rgba(212, 175, 55, 0.1); color: #aa8929; padding: 6px 12px; border-radius: 20px; font-size: 0.75rem; border: 1px solid rgba(212, 175, 55, 0.3); font-weight: 700; text-transform: uppercase; letter-spacing: 1px; white-space: nowrap;">${product.category}</span></td>
                `;
